// Access DOM ELEMENTS OF THE CALCULTOR
...
function negate() {
  // Nagate the result if expression is empty and result is present
  if(expression === '' && result !== '') {
    result = -result;
...
function percentage() {
  ...
  if(expression !== ''){
    ...
    // of expression is empty but the result exixits, divide by 100
